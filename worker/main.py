...
import asyncio
from src.models.generate import GPT
        ...
        if response:
            for stream, messages in response:
                ...
                for message in messages:
                    ...
                    input_var = ["" + i['msg'] for i in message_data]
                    input_var1 = " ".join(input_var)

                    res = GPT(model_path="ggml-gpt4all-j-v1.3-groovy.bin").langchain(input_var1)
                    print(res)
                    msg = Message(
                        msg=res
                    )
